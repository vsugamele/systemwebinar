                  ...
                  <tr key={w.id}>
                    ...
                    <td>
                      <div style={{ display: 'flex', gap: 8 }}>
                        ...
                        <button className="btn btn-secondary btn-sm" onClick={() => openEdit(w)}>Editar</button>
                        <Link href={`/register/${w.slug}`} target="_blank" className="btn btn-ghost btn-sm">Landing ↗</Link>
                        <Link href={`/w/${w.slug}`} target="_blank" className="btn btn-ghost btn-sm">Sala ↗</Link>
