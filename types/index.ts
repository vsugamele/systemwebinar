...
export type SessionEventType = 'page_view' | 'joined' | 'play_started' | 'watch_second' | 'watch_milestone_30min' | 'progress_25' | 'progress_50' | 'progress_75' | 'progress_90' | 'cta_clicked' | 'cta_dismissed' | 'popup_seen' | 'popup_dismissed' | 'left' | 'chat_sent' | 'trigger_in_webinar_email'
